...
////    unsigned char *data = stbi_load("/Users/toastoffee/Documents/CLionProjects/2d-pixel-renderer/images/awesomeface.png", &width, &height, &nrChannels, 0);
////    if (data)
////    {
...
//
//    LoadTextureFromFile("/Users/toastoffee/Documents/CLionProjects/2d-pixel-renderer/images/mario_doc.ppm", &tex, &width, &height);
//
//
//    // Main loop
//#ifdef __EMSCRIPTEN__
